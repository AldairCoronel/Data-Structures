...
public abstract class MeteSaca<T> {
    ...
    @Override public boolean equals(Object o) {
        ...
        Nodo auxiliarI = m.cabeza;
        Nodo auxiliarF = cabeza;
        while(auxiliarI != null && auxiliarF != null){
            if(!auxiliarI.elemento.equals(auxiliarF.elemento))
              return false;
            auxiliarI = auxiliarI.siguiente;
            auxiliarF = auxiliarF.siguiente;
        }
        if(auxiliarI != null || auxiliarF != null)
          return false;
        return true;
    }
}
